...
public class JEliminarInsumo extends javax.swing.JDialog {
     ...
     */
    public JEliminarInsumo(Dialog f, boolean b) {
        super(f, b);
        initComponents();
    ...
    private void buttonSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSeleccionarActionPerformed
        ...
        try{
            ...
            resultado = logicaNegocio.eliminarInsumo(insumoSeleccionado.getidInsumo());
            super.dispose();
        }catch(Exception e){
